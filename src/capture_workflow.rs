...
pub(crate) const CAPTURE_TOOLBAR_WIDTH: f32 = 703.0;
    ...
    let result: Result<String> = async {
        match action {
            ...
            SelectionPurpose::Ocr | SelectionPurpose::OcrTranslate | SelectionPurpose::Vlm => {
                ...
                let language = toolbar.get_ocr_language_tag().to_string();
                if language.is_empty() {
                    anyhow::bail!("No Windows OCR language pack is installed");
                }
